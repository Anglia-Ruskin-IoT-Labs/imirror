...
class BuildGUI(threading.Thread):
    ...
    def run(self):
        ...
        self.root.bind("<Up>", self.toggle_gui)
        self.root.bind("<Down>", self.toggle_weather)
        self.root.bind("<Right>", self.toggle_clock)
        self.root.bind("<Left>", self.toggle_news)
        self.root.bind("<Escape>", self.toggle_all)
    ...
    def toggle_clock(self, event=None):
        self.right_frame.pack(side=tk.RIGHT, anchor=tk.NE)
        return "break"
    
    def toggle_news(self, event=None):
        self.bottom_frame.pack(side=tk.BOTTOM, anchor=tk.SE)
        return "break"
